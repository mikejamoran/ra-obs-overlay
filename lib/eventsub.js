...
// ── Client factory ──────────────────────────────────────────────────────────────
// One client per user; deps = { getState, handleEvent, helixRequest, onAuthRevoked }.

function createEventSub(deps) {
...
function normalize(payload) {
  ...
  return { refresh, stop, missingScopes };
}

module.exports = { createEventSub, SCOPE_REQS };
